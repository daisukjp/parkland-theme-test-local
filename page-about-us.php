...
<div class="about-us-section">
    ...
    <h1>A Brief History about Parkland Tai Chi...</h1>
...
<div class="contact-info-section">
    <div class="about-contact-info">
        ...
        <p>Center 16 Building</p>
        <p>Suite 205, 95 McLeod Avenue</p>
        <p>Spruce Grove, AB T7X 2Z6</p>
        <p><a href="tel:+1780-982-3033">(780) 982-3033</a></p>
        <p><a href="tel:+1780-940-0381">(780) 940-0381</a></p>
    </div>
...
<div class="about-us-faq">
        ...
        <div class="faq-item">
            <h4>How long does it take to learn Tai Chi?</h4>
        ...
        <div class="faq-item">
            <h4>Do I build muscle when I practice Tai Chi?</h4>
        ...
        <div class="faq-item">
            ...
            <p>It is not recommended. Your feet should be supported.</p>
        </div>
        <div class="faq-item">
        ...
        <div class="faq-item">
            <h4>I have some disabilities, is Tai Chi for me?</h4>
            <p>Most of the time if you can walk, you can do Tai Chi. We recommend anyone with underlying
            health conditions consult with a healthcare professional.
            </p>
        </div>
        <div class="faq-item">
            <h4>Is this for Children?</h4>
            <p>
                Our organization is offered to anyone over the age of 18.
            </p>
        </div>
